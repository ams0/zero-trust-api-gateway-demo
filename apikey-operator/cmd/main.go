...
import (
	...
	"github.com/ams0/zero-trust-api-gateway-demo/apikey-operator/internal/controller"
)
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "apikey-operator.gateway.zerotrust.io",
	})
	if err != nil {
	...
	setupLog.Info("starting apikey-operator", "gatewayNamespace", os.Getenv("GATEWAY_NAMESPACE"))
